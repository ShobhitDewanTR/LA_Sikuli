...
//						s.type("New"+type1+type2+"TemplateDescription");
	...
	@Parameters({"param0","param1","param2","param3","param4","param5","param6","param7","param8","param9"})
	@Test
	public static void VerifyTemplateRecreateScenarios(String type,String Hdln, String usn,String pdct, String tpc, String ric, String slg, String catcode,String nmditm,String bdy) throws FindFailed, InterruptedException {
		test = extent.createTest(MainRunner.TestID,MainRunner.TestDescription);
		int status;
		String nameofCurrMethod = new Throwable()
                .getStackTrace()[0]
		...
		try {
			...
			if(status==1) {
				...
				if (s.exists(Patternise("Expand"+type,"Moderate")) != null) {
					...
					s.keyDown(Key.ENTER);
					s.keyUp(Key.ENTER);
					if (s.exists(Patternise("OKTemplate","Moderate")) != null) {
						s.wait(Patternise("OKTemplate","Moderate"),1).click();
					}
					if (s.exists(Patternise("PopupYes","Moderate")) != null) {
						s.wait(Patternise("PopupYes","Moderate"),1).click();
					...
					test.pass("Saved "+type+" data");
					s.wait(Patternise("Delete","Moderate"),2).click();
					test.pass("Deleted newly created Asset");
					//Goto Template Section
					s.wait(Patternise("Templates","Moderate"),2).click();
					Thread.sleep(3000);
					test.pass("Navigated to template section");
					...
					if (s.exists(Patternise("New"+type+"TemplateDescription","Moderate")) != null) {
						test.pass(type+ " template found in template section");
						//code for right click and recreate in workspace
						s.wait(Patternise("New"+type+"TemplateDescription","Moderate"),1).rightClick();
						test.pass("Right Clicked on Template");
						s.wait(Patternise("CreateInWorkspace","Moderate"),3).click();
						test.pass("Clicked on Create in Workspace option");
						s.wait(Patternise("Workspace","Moderate"),3).click();
						test.pass("Clicked on Workspace Option");
						//s.wait(Patternise("ExpandBundle","Moderate"),2).click();
						Thread.sleep(3000);
						if (s.exists(Patternise("TemplateTest"+type+"Headline1","Moderate")) != null) {
							test.pass("Value of asset is saved when " + type +" template is recreated in workspace");
							s.wait(Patternise("Delete","Moderate"),2).click();
							test.pass("Deleted the newly recreated "+type);
						}
						else
						{ 
							test.fail("Value of asset is not saved when "+type+" template is recreated in workspace");
						}
						s.wait(Patternise("Templates","Moderate"),2).click();
						Thread.sleep(3000);
						test.info("Navigating to Templates section");
	...
	@Parameters({"param0","param1","param2","param3","param4","param5","param6","param7","param8","param9","param10","param11","param12","param13","param14","param15","param16","param17","param18","param19"})
	@Test
	public static void VerifyPackageTemplateRecreateScenarios(String type1,String Hdln1, String usn1,String pdct1, String tpc1, String ric1, String slg1, String catcode1,String nmditm1,String bdy1,String type2,String Hdln2, String usn2,String pdct2, String tpc2, String ric2, String slg2, String catcode2,String nmditm2,String bdy2) throws FindFailed, InterruptedException {
		test = extent.createTest(MainRunner.TestID,MainRunner.TestDescription);
		int status;
		String nameofCurrMethod = new Throwable()
                .getStackTrace()[0]
		...
		try {
			...
			if(status==1) {
				...
				if (s.exists(Patternise("Expand"+type1,"Moderate")) != null) {
					...
					test.pass("Deleted newly created Bundle");
					//Goto Template Section
					s.wait(Patternise("Templates","Moderate"),2).click();
					Thread.sleep(3000);
					test.pass("Navigated to template section");
					...
					if (s.exists(Patternise("New"+type1+type2+"TemplateDescription","Moderate"),3) != null) {
						test.pass(type1+type2+ " template found in template section");
						//code for right click and recreate in workspace
						s.wait(Patternise("New"+type1+type2+"TemplateDescription","Moderate"),1).rightClick();
						test.pass("Right Clicked on Template");
						s.wait(Patternise("CreateInWorkspace","Moderate"),3).click();
						test.pass("Clicked on Create in Workspace option");
						s.wait(Patternise("Workspace","Moderate"),3).click();
						...
						Thread.sleep(3000);
						if (s.exists(Patternise("TemplateTest"+type1+"Headline1","Moderate")) != null && s.exists(Patternise("TemplateTest"+type2+"Headline2","Moderate")) != null) {
							test.pass("Value of asset is saved when bundle template is recreated in workspace");
							while(s.exists(Patternise("Delete","Strict")) != null) {
								s.click(Patternise("Delete","Strict"));
								s.mouseMove(Patternise("NewWorkspace","Moderate").targetOffset(0,-15));
							}
							test.pass("Deleted the newly recreated Bundle");
						}
						else
						{ 
							test.fail("Value of asset is not saved when bundle template is recreated in workspace");
						}
						s.wait(Patternise("Templates","Moderate"),2).click();
						Thread.sleep(3000);
						test.info("Navigating to Templates section");
